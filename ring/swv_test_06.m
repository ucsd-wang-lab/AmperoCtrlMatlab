...
%% Parameter file read
    function filereadbutton_Callback(source,eventdata)
        ...
        %Hardware paremeters
        dummy               = param(21);
        HW_ADC_VREF         = str2double(param(22));    % Vref in mV
        HW_ADC_RESOLUTION	= str2double(param(23));    % ADC resolution (bits)
        HW_RIV           = str2double(param(24));    % Transimpedance gain (kOhm)
